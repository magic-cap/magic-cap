...
The resulting (fixed, tiny) Magic Cap string can be combined with the data file for the secret data; either part by itself cannot learn the secret data.
...
#+begin_src bash
cargo run -- decrypt --url https://github.com/magic-cap/magic-cap/raw/refs/heads/main/kitten.mcap mcap0rajRAVOgzmSuSsNQt5yA5JAEypic23eM5kRtGp9b5Mq2etDldhibLLwEzHOSOHAo3 | display
#+end_src
...
The mcap to unlock it is: =mcap0rajRAVOgzmSuSsNQt5yA5JAEypic23eM5kRtGp9b5Mq2etDldhibLLwEzHOSOHAo3=
...
#+begin_src sh
  cargo run -- verify --ciphertext kitten.mcap mcap0v-Gshm9tyvjXDnfWpLWKMgjcK0AOdC-O12vvLW5rxeV4
#+end_src
...
| bruennhilde.jpeg         | mcap0rY2fm_lVL33W9-DfIUH01EzAT7fUQ3c5lZEGuZW-WyppXBR8ws_mMNghZAg7wxIUB |
| cat-on-shoulder.jpeg     | mcap0rkPgNO_PLPHYnsF21xsuZWclI8Eodt3198G99I3bbgwTcfvRs0AqvJn6vJ0FvBd29 |
| kittens-in-basket.jpeg   | mcap0r0H3nq1ecRFORya6czK8kKwejLpKrvzXTtjQUicqwVt7Fc_G2zfxP3Y174gxWjq_L |
| the-cook.jpeg            | mcap0rUMgHUlMK6fb19D3CHII-NLpgwsaGM8xGYpsXJzDELyaR-PnhNiSaudTksLaJaoY7 |
| three-jolly-kittens.jpeg | mcap0rQOVWH5aeWoZtCJ8GThDs8hSWfcJm0UMAaswgoifCIN1yA0AtLIGfFy-aJRW_7hzP |
