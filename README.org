...
#+begin_src bash
cargo run -- decrypt --url https://github.com/magic-cap/magic-cap/raw/refs/heads/main/kitten.mcap mcap0vCaeC8weUj758t7AedxEy3jwepUmAyX8p_owj0gf8OCU | display
#+end_src
...
The mcap to unlock it is: =mcap0rCaeC8weUj758t7AedxEy3jwepUmAyX8p_owj0gf8OCUI5lWGYVP_kbtsri8ihrwF=
If you're using "cargo" a command-line to do that is:

#+begin_src sh
  cargo run -- decrypt --ciphertext kitten.mcap mcap0rCaeC8weUj758t7AedxEy3jwepUmAyX8p_owj0gf8OCUI5lWGYVP_kbtsri8ihrwF --plaintext kitten.jpeg
#+end_src
...
#+begin_src sh
  cargo run -- verify --ciphertext kitten.mcap mcap0vCaeC8weUj758t7AedxEy3jwepUmAyX8p_owj0gf8OCU
#+end_src
