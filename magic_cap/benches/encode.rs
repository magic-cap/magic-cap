...
fn criterion_benchmark(c: &mut Criterion) {
    c.bench_function("encode 1 MiB (4096)", |b| b.iter(|| encode(black_box(4096), black_box(1*1024*1024))));
    c.bench_function("encode 1 MiB (8192)", |b| b.iter(|| encode(black_box(8192), black_box(1*1024*1024))));
}
